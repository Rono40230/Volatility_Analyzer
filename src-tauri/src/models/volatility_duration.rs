...
mod tests {
    ...
    fn test_volatility_duration_creation() {
        ...
        assert_eq!(vd.recommended_trade_expiration_minutes, 150); // max(150, 120)
    ...
    fn test_trade_expiration_max_logic() {
        // Cas où half_life × 2 > peak_duration
    ...
    fn test_validation() {
        ...
        // Invalid: zero peak_duration
        let mut invalid = valid.clone();
        invalid.peak_duration_minutes = 0;
        assert!(!invalid.is_valid());

        // Invalid: half_life >= peak_duration
        let mut invalid = valid.clone();

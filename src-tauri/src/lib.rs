...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            update_symbol_for_description, // NEW: Mettre à jour le symbole par description
            list_orphan_events,
            delete_orphan_events,
            preview_cleanup_events, // NEW: Prévisualiser les événements à supprimer
            list_impact_groups, // NEW: Lister les groupes d'impact
            update_impact_for_description, // NEW: Mettre à jour l'impact par description
            delete_events_by_impact, // NEW: Supprimer les événements par impact

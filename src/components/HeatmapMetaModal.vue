    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div v-else class="placeholder-content">
          <div class="info-box">
            <h3>📊 Analyse Globale des Corrélations</h3>
            <p>Cette fonctionnalité permettra de comparer l'évolution des corrélations dans le temps.</p>
            <ul>
              <li>Quels événements deviennent plus impactants ?</li>
              <li>Quelles paires réagissent le plus fort globalement ?</li>
              <li>Saisonnalité des corrélations</li>
            </ul>

...
.dropdown-header { display: flex; align-items: center; width: 100%; height: 42px; padding: 0 12px; border: 1px solid #ccc; border-radius: 6px; background: #ffffff; transition: all 0.3s; overflow: hidden; gap: 8px; box-sizing: border-box; }
.dropdown-header:hover { border-color: #999; background: #f9f9f9; }
.dropdown-input { flex: 1; background: transparent; border: none; color: #000000; font-size: 0.9rem; outline: none; cursor: text; padding: 0; margin: 0; height: 100%; }
...
.dropdown-menu { position: absolute; top: 100%; left: 0; width: 100%; margin-top: 4px; background: #ffffff; border: 1px solid #ccc; border-radius: 6px; max-height: 300px; overflow-y: auto; z-index: 10; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.15); }
.empty-message { padding: 16px; text-align: center; color: #999999; font-size: 0.9em; }
.dropdown-item { display: flex; align-items: center; gap: 12px; width: 100%; padding: 8px 12px; background: transparent; border: none; color: #000000; text-align: left; cursor: pointer; transition: all 0.2s; font-size: 0.9rem; box-sizing: border-box; }
